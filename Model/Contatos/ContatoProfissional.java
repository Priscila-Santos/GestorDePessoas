...
public class ContatoProfissional extends Contato {
    ...
    public ContatoProfissional(String nome, String telefone, String endereco, String email, String empresa, String cargo,List<ContatoProfissional> contatosProfissionais) {
    ...
    public static String editarContatoProfissional() {
        try {
            ...
            if(index >= 0 && index < contatos.size()){
                ...
                String nome = ScannerUtil.ler("Nome (" + contatoProfissional.getNome() + "): ");
                ...
                if (contatoProfissional != null) {
                    ...
                    switch (opcao) {
                        case 1:
                            ...
                            contatoProfissional.setNome(novoNome);
                            break;
                        case 2:
